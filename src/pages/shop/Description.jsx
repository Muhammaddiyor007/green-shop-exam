...
const Description = () => {
  return (
    <div className="container footer text-[14px] text-[#727272] flex flex-col gap-[18px]">
      ...
      <div className="flex flex-col gap-1">
        <p className="font-bold text-[14px] text-black">Living Room:</p>
      ...
      <div className="flex flex-col gap-1">
        <p className="font-bold text-[14px] text-black"> Dining Room:</p>
        <p className="text-[14px]">
      ...
      <div className="flex flex-col gap-1">
        <p className="font-bold text-[14px] text-black">Office:</p>
        <p className="text-[14px]">
          The ceramic cylinder planters come with a wooden stand to help elevate
          your plants off the ground. The ceramic cylinder planters come with a
          wooden stand to help elevate your plants off the ground. Lorem ipsum
